...
source(here('qrps_sose25', 'scripts', 'class5', 'class5_dataprep_cod_Wuillemet.R'))
...
frml_fit_7 <- 'self_lr ~ redistr_z2 + regulation_z2 + age_z2 + gender + edu_rec' #dependent var not standardized 
...
# might be differnt by chance since they overlapp 
